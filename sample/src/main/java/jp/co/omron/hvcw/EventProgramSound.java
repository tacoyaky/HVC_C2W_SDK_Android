 ...
 * 音声検知イベントプログラム
 */
public final class EventProgramSound
{
	/** 音声検知イベント設定 */
	private EpSoundEvent    soundEvent;
	/** OKAO処理設定 */
	 ...
	 * コンストラクタ
	 */
	public EventProgramSound()
	{
		this.soundEvent    = new EpSoundEvent();
	...
	/**
	 * コンストラクタ
	 * @param soundEvent 音声検知イベント設定
	 * @param okaoProcess OKAO処理設定
	 * @param postProcess 通知処理設定
	 * @param frPostProcess 顔認証専用通知処理設定
	 */
	public EventProgramSound(EpSoundEvent soundEvent, EpOkaoProcess okaoProcess,
							EpPostProcess postProcess, EpFrPostProcess frPostProcess)
	{
		this.soundEvent    = new EpSoundEvent(soundEvent.getSensitivity(), soundEvent.getDuration(),
												soundEvent.getRatio(), soundEvent.getOffPeriod());
	 ...
	 * @return 音声検知イベント設定
	 */
	public EpSoundEvent getEpSoundEvent()
	{
	 ...
	 * @param soundEvent 音声検知イベント設定
	 */
	public void setEpSoundEvent(EpSoundEvent soundEvent)
	{
		this.soundEvent = new EpSoundEvent(soundEvent.getSensitivity(), soundEvent.getDuration(),
												soundEvent.getRatio(), soundEvent.getOffPeriod());
	}
